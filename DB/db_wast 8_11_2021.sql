...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 07, 2021 at 06:00 PM
...
CREATE TABLE `admin_member` (
  ...
  `Role` varchar(100) NOT NULL COMMENT 'ตำแหน่ง'
...
INSERT INTO `admin_member` (`ID`, `Username`, `Password`, `Firstname`, `Lastname`, `Role`) VALUES
(2, '63114640591', 'Rasi0570', 'รติพงษ์', 'ศิลากิจ', 'Dev');
...
INSERT INTO `member` (`idmember`, `username`, `point`) VALUES
(1, '63114640591', 30),
(7, '63114640492', 0);
...
INSERT INTO `orders` (`idorder`, `rewards_idrewards`, `member_username`, `time`) VALUES
(1, 1, '63114640591', '2021-11-07 16:45:14'),
(3, 3, '63114640591', '2021-11-07 16:56:33');
...
INSERT INTO `rewards` (`idrewards`, `name`, `img`, `detail`, `score`) VALUES
(1, 'Edutainment Zone', 'edu02.jpg', 'จอง Edutainment Zone ได้สองช่วงเวลาต่อคนต่อวัน', 100),
(2, 'แก้ว', 'แก้ว.jpg', 'LOCK&LOCK แก้วเก็บความร้อน-เย็น รุ่น Lip tumbler LHC4164', 200),
(3, 'ถุงผ้า', 'ถุงผ้า.jpg', 'ถุงผ้าพร้อมสกรีนลายรักษ์โลก\n', 70);
...
INSERT INTO `score` (`idscore`, `proof`, `no_throw`, `score`, `time`, `waste_types_idwaste_types`, `member_username`) VALUES
(7, '127212826_1454177421445426_192548810745475700', 1, NULL, '2021-11-07 15:57:26', 2, '63114640591'),
(8, 'ฟ410.jpg', 1, NULL, '2021-11-07 15:58:50', 2, '63114640591');
...
--
ALTER TABLE `rewards`
  MODIFY `idrewards` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `score`
--
ALTER TABLE `score`
  MODIFY `idscore` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
